...
const buildSuggestions = (experiences) => {
  const canonicalExperiences = chooseCanonicalExperiences(experiences);

  return canonicalExperiences.map((experience) => {
    ...
    return {
      ...
      currentMood: experience.mood || null,
      currentIntensity: experience.intensity || null,
